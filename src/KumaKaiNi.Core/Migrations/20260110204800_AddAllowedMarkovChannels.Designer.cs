...
namespace KumaKaiNi.Core.Migrations
{
    ...
    [Migration("20260110204800_AddAllowedMarkovChannels")]
    partial class AddAllowedMarkovChannels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KumaKaiNi.Core.Database.Entities.AllowedMarkovChannels", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("AllowedMarkovChannels");
                });
            ...
            modelBuilder.Entity("KumaKaiNi.Core.Database.Entities.Markov", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("NextWord")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("next_word");

                    b.Property<string>("PreviousWords")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("previous_words");
                    ...
                    b.HasIndex("SourceSystem", "ChannelId", "CanStart");

                    b.HasIndex("SourceSystem", "ChannelId", "PreviousWords");

                    b.HasIndex("SourceSystem", "ChannelId", "PreviousWords", "NextWord")
                        .IsUnique();
